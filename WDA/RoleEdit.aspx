<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RoleEdit.aspx.cs" Inherits="WDA.RoleEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div class="alert alert-info">
        ...
        <h4>說明：</h4>
        <ol>
            <li>輸入「修改項目」，完成後請按【修改】鍵執行新增動作。</li>
    ...
    <div class="well well-lg">
           <div class="panel panel-primary">
               <div class="panel-heading">
                   <h3 class="panel-title">角色管理─編輯角色：</h3>
               </div>
               <div class="panel-body">
                   ...
                   <table style="width: 100%; text-align: center; padding: 3px; border: 1px; border-spacing: 1px; border-top: 1px solid #FFFFFF; border-left: 1px solid #FFFFFF; border-right: 1px solid #FFFFFF; border-bottom: 1px solid #FFFFFF">
                    <tr style="text-align: center">
                        <td>
                            <asp:Button ID="Button1" runat="server" Text="修 改" class="btn btn-large btn-success" OnClick="BtnOK_Click"/>
                        </td>
                        <td>
