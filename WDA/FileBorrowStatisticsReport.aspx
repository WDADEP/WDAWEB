<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FileBorrowStatisticsReport.aspx.cs" Inherits="WDA.FileBorrowStatisticsReport" %>
    ...
    <div class="well well-lg">
     ...
     <asp:TextBox ID="txtBorrowCreateTime" runat="server"  title="日期格式"></asp:TextBox>
        ...
        <div id="divPanel">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">借檔作業─統計列表如下：</h3>
                </div>
                <div class="panel-body">
                    <div style="width: 98%; text-align: right">
                        <asp:Button ID="BtnPrint" runat="server" Text="列 印" class="btn btn-large btn-success" OnClientClick="var scriptName=document.forms[0].action;window.document.forms[0].target='_blank';setTimeout(function(){window.document.forms[0].target='';document.forms[0].action=scriptName;}, 500);" PostBackUrl="~/FileBorrowGroupPrint.aspx" />
                    </div>
                </div>
                <asp:GridView ID="GridView1" runat="server" AllowSorting="True"  AutoGenerateColumns="False" CssClass="GridViewStyle" Width="98%" OnSorting="GridView1_Sorting" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDataBound="GridView1_RowDataBound" >
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="匯出細項資料">
                            <ItemTemplate>
                                <asp:Button ID="BtnDetailPrint" runat="server" Text="匯出細項資料" class="btn btn-default btn-xs" OnClick="BtnDetailPrint_Click" PostBackUrl="~/FileBorrowDetailPrint.aspx" OnClientClick="JavaScript:if(!ImageBtnPringClick()) {return false} ;"/>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
