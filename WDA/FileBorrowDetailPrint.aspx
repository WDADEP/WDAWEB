<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileBorrowDetailPrint.aspx.cs" Inherits="WDA.FileBorrowDetailPrint" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
                        <LocalReport ReportPath="RptFileBorrowDetail.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>
                </ContentTemplate>
            </asp:UpdatePanel>
