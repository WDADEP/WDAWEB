<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FileSearch.aspx.cs" Inherits="WDA.FileSearch" %>
    ...
    <script type="text/javascript">
        ...
        function ImageBtnOKClick() {
            try {
                ...
                var txtTxtBorrowUserName = $get('MainContent_TxtBorrowUserName').value;
                ...
                if (txtTxtBorrowUserName.length == 0) {
                    alert('借檔人為空');
                    return false;
                }
       ...
       <div class="well well-lg">
           <div class="panel panel-primary">
               <div class="panel-heading">
                   <h3 class="panel-title">檔案借閱─未還檔查詢</h3>
               </div>
               <div class="panel-body">
                   <table class="ItemTD_green" style="width: 98%; float: right; border-collapse: separate; border-spacing: 1px;" border="1">
                       ...
                       <tr>
                           <td class="HeadTD_green" style="padding: 5px;">借檔人：
                           </td>
                           <td style="padding: 5px; text-align: left;">
                               <asp:TextBox ID="TxtBorrowUserName" runat="server"></asp:TextBox>
                            </td>
                       </tr>
                   </table>
               </div>
           ...
           <div id="divPanel">
               ...
               <div class="panel panel-primary">
                   ...
                   <div class="panel-body">
                        <h5 class="panel-title">檔案狀況(未還檔)：</h5>
                   <div style="width: 98%">
