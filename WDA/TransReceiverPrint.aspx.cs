...
namespace WDA
{
    public partial class TransReceiverPrint : PageUtility
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    try
                    {
                        ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("TransReceiverTable", dt));
                        ReportViewer1.SizeToReportContent = true;
                    }
        ...
        private DataTable getReportDataTable()
        {
            ...
            try
            {
                ...
                strSql = Session["Transtable"].ToString();

                this.WriteLog(global::Log.Mode.LogMode.DEBUG, "TransReceiver：Session：GetReportData");
